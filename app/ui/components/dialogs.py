...
def default_notif_dialog(
    icon: ft.IconValue | None = ft.Icon(name=ft.Icons.DATA_OBJECT, color=ft.Colors.PRIMARY, size=50),
    ...
    dialog = ft.AlertDialog(
        ...
        title=(
            ...
            else default_text(DefaultTextStyle.TITLE, title) if isinstance(title, str)
            else None
        ),
...
py -m app.ui.components.dialogs
"""
