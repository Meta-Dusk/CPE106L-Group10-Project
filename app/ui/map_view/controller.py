...
def zoom_in(page, image_grid, pickup_lat_input, pickup_lon_input, dest_lat_input, dest_lon_input, pin_status):
...
def zoom_out(page, image_grid, pickup_lat_input, pickup_lon_input, dest_lat_input, dest_lon_input, pin_status):
...
def pan_map(dx, dy, page, image_grid, pickup_lat_input, pickup_lon_input, dest_lat_input, dest_lon_input, pin_status):
