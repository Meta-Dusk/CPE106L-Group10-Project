...
async def animate_slide_in(control: ft.Control, duration_in_milliseconds: int = 500):
    ...
    control.animate_opacity = ft.Animation(duration=duration_in_milliseconds, curve=ft.AnimationCurve.EASE_OUT_CUBIC)
    control.animate_rotation = ft.Animation(duration=duration_in_milliseconds, curve=ft.AnimationCurve.EASE_IN_CUBIC)
    control.opacity = 1.0
...
async def teeter_right(control: ft.Control, duration_in_milliseconds: int = 500):
    ...
    control.offset = ft.Offset(0.0, 0.25)
